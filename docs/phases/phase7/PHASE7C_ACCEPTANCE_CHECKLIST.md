...
### 17.1 验收统计 (编写期冻结验收点框架, 实施后填写; 2026-08-19 收尾轮审计; 2026-08-20 C-3 装机闭环更新)
...
> 未通过 6 项全部为**预批占位/N-A 级放行**性质 (NP6 边界替代 × 2, 汇总占位 × 1, 性能 N/A-级 × 3), 无功能性缺陷; 功能、数值、幻觉点、ADR、scope、规范、复用、风险八个核心维度 100%。C-3 (Stata NP MAIC 硬断言) 已于 2026-08-20 装机闭环并连带修复 σ̂² 分母实现 bug (详见 §3.1.1)。
...
> **v1.7 发布条件 C-1/C-2 已全部闭环 (2026-08-20)**; **C-3 亦于同日装机闭环** (原列 v1.8 前非阻塞项, Stata 18 提前装机直接完成) — 仅余 C-4 一项 v1.8 评估项。
